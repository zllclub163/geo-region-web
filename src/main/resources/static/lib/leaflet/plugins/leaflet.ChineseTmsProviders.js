...
L.TileLayer.ChinaProvider.providers = {
    ...
    Google: {
        Normal: {
            Map: "//us.iotchs.xyz:82/maps/vt?lyrs=m@189&gl=cn&x={x}&y={y}&z={z}"
        },
        Satellite: {
            Map: "//us.iotchs.xyz:82/maps/vt?lyrs=s@189&gl=cn&x={x}&y={y}&z={z}",
    ...
    TERRAIN: {
        Normal: {
            Map: "//{s}.tile.opentopomap.org/{z}/{x}/{y}.png",
        },
        Subdomains: ['a', 'b', 'c']
    },
    Baidu: {
